...
class Iface(object):
  ...
  def scanner_get_profile_data(self, scanner):
    """
  ...
  def async_scanner_get_profile_data(self, scanner):
    """
...
class Client(Iface):
  ...
  def send_scanner_get_profile_data(self, scanner):
    self._oprot.writeMessageBegin('scanner_get_profile_data', TMessageType.CALL, self._seqid)
    args = scanner_get_profile_data_args()
    args.scanner = scanner
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_scanner_get_profile_data(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      ...
      iprot.readMessageEnd()
      raise x
    result = scanner_get_profile_data_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    if result.e is not None:
      raise result.e
    raise TApplicationException(TApplicationException.MISSING_RESULT, "scanner_get_profile_data failed: unknown result")
  ...
  def send_async_scanner_get_profile_data(self, scanner):
    self._oprot.writeMessageBegin('async_scanner_get_profile_data', TMessageType.CALL, self._seqid)
    args = async_scanner_get_profile_data_args()
    args.scanner = scanner
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_async_scanner_get_profile_data(self):
    iprot = self._iprot
    (fname, mtype, rseqid) = iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      ...
      iprot.readMessageEnd()
      raise x
    result = async_scanner_get_profile_data_result()
    result.read(iprot)
    iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    if result.e is not None:
      raise result.e
    raise TApplicationException(TApplicationException.MISSING_RESULT, "async_scanner_get_profile_data failed: unknown result")
...
class Processor(Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap["scanner_get_profile_data"] = Processor.process_scanner_get_profile_data
    self._processMap["async_scanner_get_profile_data"] = Processor.process_async_scanner_get_profile_data
  ...
  def process_scanner_get_profile_data(self, seqid, iprot, oprot):
    args = scanner_get_profile_data_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = scanner_get_profile_data_result()
    try:
      result.success = self._handler.scanner_get_profile_data(args.scanner)
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except ClientException as e:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("scanner_get_profile_data", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def process_async_scanner_get_profile_data(self, seqid, iprot, oprot):
    args = async_scanner_get_profile_data_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = async_scanner_get_profile_data_result()
    try:
      result.success = self._handler.async_scanner_get_profile_data(args.scanner)
      msg_type = TMessageType.REPLY
    except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
      raise
    except ClientException as e:
      ...
      logging.exception(ex)
      result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
    oprot.writeMessageBegin("async_scanner_get_profile_data", msg_type, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class scanner_get_profile_data_args(object):
  """
  Attributes:
   - scanner
  """
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('scanner_get_profile_data_args')
...
class scanner_get_profile_data_result(object):
  """
  Attributes:
   - success
   - e
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (ScanProfileData, ScanProfileData.thrift_spec), None, ), # 0
    (1, TType.STRUCT, 'e', (ClientException, ClientException.thrift_spec), None, ), # 1
  )
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('scanner_get_profile_data_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.STRUCT, 0)
      self.success.write(oprot)
      oprot.writeFieldEnd()
...
class async_scanner_get_profile_data_args(object):
  """
  Attributes:
   - scanner
  """
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('async_scanner_get_profile_data_args')
    if self.scanner is not None:
      oprot.writeFieldBegin('scanner', TType.I64, 1)
      oprot.writeI64(self.scanner)
      oprot.writeFieldEnd()
...
class async_scanner_get_profile_data_result(object):
  """
  Attributes:
   - success
   - e
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('async_scanner_get_profile_data_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.STRUCT, 0)
      self.success.write(oprot)
      oprot.writeFieldEnd()
