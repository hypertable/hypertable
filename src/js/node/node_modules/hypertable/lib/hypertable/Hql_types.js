...
HqlResult = module.exports.HqlResult = function(args) {
  ...
  if (args) {
    ...
    if (args.scan_profile_data !== undefined && args.scan_profile_data !== null) {
      this.scan_profile_data = new Client_ttypes.ScanProfileData(args.scan_profile_data);
    }
  }
};
HqlResult.prototype = {};
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.STRUCT) {
        this.scan_profile_data = new Client_ttypes.ScanProfileData();
        this.scan_profile_data.read(input);
      } else {
        input.skip(ftype);
      }
      break;
...
HqlResult.prototype.write = function(output) {
  ...
  if (this.scan_profile_data !== null && this.scan_profile_data !== undefined) {
    output.writeFieldBegin('scan_profile_data', Thrift.Type.STRUCT, 5);
    this.scan_profile_data.write(output);
    output.writeFieldEnd();
  }
